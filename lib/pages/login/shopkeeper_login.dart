...
import '../shopkeeper/dashboard_wrapper.dart';
            ...
            children: [
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: AppTheme.shopkeeperPrimary.withOpacity(0.2),
                            blurRadius: 15,
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(20),
                    borderSide: const BorderSide(color: AppTheme.shopkeeperPrimary, width: 2),
                  ),
                ),
              ),
              ...
              Row(
                ...
                children: [
                  TextButton(
                    onPressed: () {},
                    child: const Text('Forgot Password?', style: TextStyle(color: AppTheme.shopkeeperPrimary, fontWeight: FontWeight.w600)),
                  ),
                ],
              ),
                        ...
                        onPressed: () async {
                          ...
                          if (success && mounted) {
                            Navigator.pushReplacement(
                              context, 
                              MaterialPageRoute(builder: (_) => const ShopkeeperDashboardWrapper())
                            );
                          } else if (mounted) {
